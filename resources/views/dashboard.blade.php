<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight pl-6">
            ...
            {{-- <div class="mt-3">
                <img style="border-radius:50%;" src="{{ asset('Upload_image/' . Auth::user()->profile_photo_path) }}" alt="image" height="100px" width="100px">
            </div> --}}
        </h2>
                ...
                <table class="table" cellpadding="15" cellspacing="0" width="100%">																
                    ...
                    <tr valign="top">
                        ...
                        <tr>
                            <td><b>Paid</b> </td>
                            <td>:</td>
                            <td><div>{{ $paid_amount = Auth::user()->booking_money_paid +Auth::user()->down_payment_paid+Auth::user()->car_parking_paid+Auth::user()->land_filling_1_paid+Auth::user()->land_filling_2_paid+Auth::user()->building_pilling_paid+Auth::user()->first_roof_casting_paid+Auth::user()->finishing_work_paid+Auth::user()->after_handover_money_paid; }}</div></td>
                        </tr>
                        <tr>
                            <td><b>Due</b> </td>
                            <td>:</td>
